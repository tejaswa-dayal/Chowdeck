...
import bikerIcon from "../assets/biker.svg" 
      ...
      <Navbar/>
        <div className='py-14 flex flex-col gap-6 justify-center items-center text-center' data-aos="zoom-in" data-aos-duration="1500">
          ...
          <div className='flex max-sm:flex-col justify-center gap-4'>
           <CTAButton color={'green'} icon={playstoreIcon} title={'Download on Google Play'} iconSize={15} size={'full'}/>
            <CTAButton color={'green'} icon={appleIcon} title={'Download on App Store'} iconSize={18} size={'full'}/>
          </div>
        </div>
        ...
        <img src={bikerIcon} className='absolute bottom-0 left-14' alt="" />
    </section>
  )
}
